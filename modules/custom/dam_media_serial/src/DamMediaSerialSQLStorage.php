...
namespace Drupal\dam_media_serial;
...
/**
 * Dam_Media_Serial storage service definition.
 *
 * @todo before going further in other impl to Dam_Media_SerialStorageInterface must be reviewed.
 *
 * SQL implementation for Dam_Media_SerialStorage.
 */
class Dam_Media_SerialSQLStorage implements ContainerInjectionInterface, Dam_Media_SerialStorageInterface {
  ...
  public function createStorageName($entityTypeId, $entityBundle, $fieldName) {
    ...
    $tableName = 'dam_media_serial_' . md5("{$entityTypeId}_{$entityBundle}_{$fieldName}");
  ...
  public function generateValueFromName($storageName, $delete = TRUE) {
    ...
    // https://www.drupal.org/node/608166
      ...
      watchdog_exception('dam_media_serial', $e);
      throw $e;
    }
  }
  ...
  public function getAllFields() {
    return \Drupal::entityManager()->getFieldMapByFieldType(Dam_Media_SerialStorageInterface::SERIAL_FIELD_TYPE);
  }
