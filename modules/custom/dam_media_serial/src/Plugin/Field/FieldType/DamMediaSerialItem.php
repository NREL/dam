...
namespace Drupal\dam_media_serial\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'dam_media_serial' field type.
 *
 * @todo should not be translatable, by default
 *
 * @FieldType(
 *   id = "dam_media_serial",
 *   label = @Translation("Dam_Media_Serial"),
 *   description = @Translation("Auto increment dam_media_serial field type."),
 *   default_widget = "dam_media_serial_default_widget",
 *   default_formatter = "dam_media_serial_default_formatter"
 * )
 */
class Dam_Media_SerialItem extends FieldItemBase {
