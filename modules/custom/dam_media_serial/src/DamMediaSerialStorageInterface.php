...
/**
 * Defines an interface for node dam_media_serial storage classes.
 */
interface Dam_Media_SerialStorageInterface {

  const SERIAL_FIELD_TYPE = 'dam_media_serial';
  ...
  /**
   * Generates a unique dam_media_serial value (unique per entity bundle).
   *
  ...
  /**
   * Creates an assistant dam_media_serial storage for a new created field.
   *
   * @param FieldDefinitionInterface $fieldDefinition
   *   Field definition.
   * @param FieldableEntityInterface $entity
  ...
  /**
   * Drops an assistant dam_media_serial storage for a deleted field.
   *
   * @param FieldDefinitionInterface $fieldDefinition
   *   Field definition.
   * @param FieldableEntityInterface $entity
  ...
  /**
   * Initializes the value of a new dam_media_serial field in existing entities.
   *
   * @param string $entityTypeId
   *   Entity type id.
   * @param string $entityBundle
